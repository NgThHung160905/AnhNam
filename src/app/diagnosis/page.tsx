    ...
    <div className="space-y-6">
      ...
      {viewingPrescription && (
        <div className="prescription-modal-backdrop fixed inset-0 bg-slate-900/50 flex items-center justify-center z-50 p-4" onClick={() => setViewingPrescription(null)}>
          <div ref={prescriptionModalRef} className="prescription-modal-container bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto" onClick={e => e.stopPropagation()}>
            <div className="prescription-sheet p-8 bg-white text-slate-800 relative rounded-xl">
              {/* Nút đóng */}
              <button
                type="button"
